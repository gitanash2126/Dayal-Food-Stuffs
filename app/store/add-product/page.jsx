...
export default function StoreAddProduct() {
  ...
  const onSubmitHandler = async (e) => {
    e.preventDefault();
    toast.success("Product added to Dayal Food Stuffs");
  };

  return (
    <form
      onSubmit={(e) =>
        toast.promise(onSubmitHandler(e), { loading: "Adding spice..." })
      }
      className="text-slate-500 mb-28"
    >
      <h1 className="text-2xl">
        Add New{" "}
        <span className="text-slate-800 font-medium">Spice Product</span>
      </h1>

      <p className="mt-7">Spice Images</p>
      ...
      <label className="flex flex-col gap-2 my-6 ">
        ...
        <textarea
          ...
          placeholder="Fresh and pure spice from Dayal Food Stuffs"
          rows={5}
      ...
      <select
        ...
        required
      >
        <option value="">Select spice category</option>

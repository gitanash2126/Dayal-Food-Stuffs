...
export default function Dashboard() {
  ...
  return (
    <div className=" text-slate-500 mb-28">
      ...
      <h2 className="text-lg font-medium text-slate-700">Customer Reviews</h2>
        ...
        {dashboardData.ratings.map((review, index) => (
          ...
          >
            <div>
              ...
              <p className="mt-3 text-slate-500 max-w-xs">{review.review}</p>
            </div>
            ...
            <div className="flex flex-col gap-4 sm:items-end">
              ...
              <button
                ...
                className="bg-slate-100 px-5 py-2 hover:bg-slate-200 rounded"
              >
                View Spice
              </button>
            </div>
